...
public class MemberMapperTests {
	 ...
	 * MemberVO();
	 * 
	 * member.setMemberId("test3"); //회원 id member.setMemberPw("test3"); //회원 비밀번호
	 * member.setMemberName("test3"); //회원 이름 member.setMemberMail("test3"); //회원 메일
	 * member.setMemberAddr1("test3"); //회원 우편번호 member.setMemberAddr2("test3");
	 * //회원 주소 member.setMemberAddr3("test3"); //회원 상세주소
	 * 
